...
class Instructeur extends BaseController
{
        ...
        if (empty($result)) {
            ...
            foreach ($result as $voertuig) {
                ...
                $tableRows .= "<tr>
                                    ...
                                    <td><a href = '"  . URLROOT . "/instructeur/overzicht_voertuig_wijzigng/$voertuig->Id/$Id'> Update</a></td>            
                            </tr>";
            }
        }
    ...
    function overzicht_voertuig_wijzigng($voertuigId, $instructeurId)
    {
        ...
        $typevoertuigen = $this->instructeurModel->getTypeVoertuig();
        $data = [
        ...
        $this->view('Instructeur/overzicht_voertuig_wijzigng', $data);
    }
    function overzichtvoertuigen_wijzig_save($voertuigId, $instructeurId)
    {
        $this->instructeurModel->updateVoertuig($voertuigId);
        $this->instructeurModel->updateVoertuig_instructeur($voertuigId);
