...
class InstructeurModel
{
    ...
    function updateVoertuig_instructeur($voertuigId)
    {
    ...
    {
        $sql = "UPDATE Voertuig SET Type = :type, Brandstof = :brandstof, Kenteken = :kenteken, TypeVoertuigId = :typevoertuig WHERE 
                Id = $voertuigId ";
        $this->db->query($sql);
